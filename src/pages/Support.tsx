      ...
      <HeroSection>
        <Container>
          <HeroContent>
            ...
            <HeroSubtitle>
              We're here to help you succeed. Get expert assistance with your web design learning journey from our dedicated support team.
            </HeroSubtitle>
          </HeroContent>
        </Container>
      </HeroSection>
            ...
            <ContactMethodsGrid>
              ...
              <ContactCard>
                ...
                <ContactContent>
                  ...
                  <ContactLink href="tel:+15753597721">
                    +15753597721
                  </ContactLink>
                </ContactContent>
              </ContactCard>
