...
const ReturnPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          DesignEcourses understands that digital products require different return considerations than physical items. 
          This policy explains our approach to web design course returns and refunds for digital educational content.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          <strong>Our web design courses are digital products delivered instantly upon purchase.</strong> Due to the nature of digital 
      ...
      <Section>
        ...
        <Paragraph>
          Since our web design courses are delivered digitally through your online account, there are no physical items to return. 
      ...
      <Section>
        ...
        <Paragraph>
          Instead of returns, we offer a 7-day satisfaction guarantee on all web design course purchases. You may request a full refund 
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your web design course:
        </Paragraph>
        <Paragraph>
          1. Email us at support@design-ecourses.com within 7 days of purchase<br/>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit to switch to a different web design course<br/>
      ...
      <Section>
        ...
        <Paragraph>
          If you're not satisfied with your current course but would like to try a different web design course from our collection, 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          and improvements. This ensures ongoing value for your investment in web design education.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          If you disagree with our refund decision, you may appeal by contacting our director at support@design-ecourses.com 
