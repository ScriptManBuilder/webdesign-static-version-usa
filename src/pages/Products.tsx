...
const Products: React.FC = () => {
  ...
  const categories = useMemo(() => [
    ...
    { id: 'WordPress Basics', name: 'WordPress Basics' },
    { id: 'WordPress Content', name: 'Content Management' },
    { id: 'WordPress Customization', name: 'Customization' },
    { id: 'WordPress Themes', name: 'Themes' },
    { id: 'WordPress Portfolio', name: 'Portfolio' },
    { id: 'WordPress Video', name: 'Video Integration' },
    { id: 'WordPress Blogging', name: 'Blogging' },
    { id: 'WordPress Forms', name: 'Forms & Interaction' },
    { id: 'WordPress Hosting', name: 'Hosting & Deployment' },
    { id: 'WordPress Page Builders', name: 'Page Builders' },
    { id: 'WordPress Client Work', name: 'Client Projects' }
  ], []);
  ...
  return (
    <ProductsWrapper>
      <Container>
        <PageHeader>
          <PageTitle>DesignEcourses Course Collection</PageTitle>
          <PageSubtitle>Master WordPress Development with our comprehensive video course library</PageSubtitle>
        </PageHeader>
