...
const ShippingPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          DesignEcourses delivers web design courses digitally through our secure online learning platform. 
      ...
      <Section>
        ...
        <Paragraph>
          <strong>Our web design courses are 100% digital products.</strong> There are no physical items to ship. All course materials, 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased web design courses. No waiting, no shipping delays - 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Add support@design-ecourses.com to your email whitelist<br/>
      ...
      <Section>
        ...
        <Paragraph>
          Our digital web design courses are available worldwide with internet access. There are no geographical restrictions 
