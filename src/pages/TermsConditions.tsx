  ...
  return (
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          By accessing and using Design Ecourses course platform and services, you accept and agree to be bound by 
          the terms and provisions of this agreement. These terms apply to all digital web design courses, educational content, and 
      ...
      <Section>
        ...
        <Paragraph>
          This web design course platform is operated by Design Ecourses. 
          Our contact information:
        </Paragraph>
        <Paragraph>
          Director: Design Education Team<br/>
          Email: support@design-ecourses.com<br/>
           Phone: +1 (575) 359-7721<br/>
          Address: Online Education Platform
        </Paragraph>
      </Section>

      <Section>
        <SectionTitle>3. Digital Web Design Course Pricing</SectionTitle>
        <Paragraph>
          Our web design courses are available at the following price points: {formatPrice(6.99)}, {formatPrice(9.99)}, {formatPrice(19.99)}, {formatPrice(29.99)}, {formatPrice(39.99)}, {formatPrice(49.99)}, {formatPrice(59.99)}, {formatPrice(69.99)}, {formatPrice(79.99)}, {formatPrice(89.99)}, and {formatPrice(99.99)}. 
      ...
      <Section>
        ...
        <Paragraph>
          We accept major credit and debit cards for web design course purchases. Your payment information is processed securely through our payment processors using 256-bit SSL encryption.
        </Paragraph>
        <Paragraph>
          <strong>Billing Descriptor:</strong> Charges will appear on your credit card statement as "DESIGN ECOURSES" or "DESIGN-ECOURSES.COM". 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased web design courses through your account dashboard. 
      ...
      <Section>
        ...
        <Paragraph>
          All web design course content, including videos, text, images, and downloadable materials, are the intellectual property of 
          Design Ecourses. You are granted a personal, non-transferable license to access and use the content 
      ...
      <Section>
        ...
        <Paragraph>
          Due to the digital nature of our web design courses, all sales are final. However, we offer a 7-day satisfaction guarantee. 
      ...
      <Section>
        ...
        <Paragraph>
          Course access is provided for your lifetime, but Design Ecourses reserves the right to terminate 
      ...
      <Section>
        ...
        <Paragraph>
          We continuously update our web design course content to reflect the latest developments in web design and user experience. 
      ...
      <Section>
        ...
        <Paragraph>
          DesignEcourses provides web design courses for educational purposes only. We make no guarantees about 
      ...
      <Section>
        ...
        <Paragraph>
          <strong>DesignEcourses</strong><br />
          Director: Design Education Team<br />
