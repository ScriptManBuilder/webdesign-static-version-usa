  ...
  return (
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          This Privacy Policy explains how DesignEcourses (the "Site", "we", "us", or "our") 
          collects, uses, and shares your personal information when you visit, interact with, or make a purchase 
          through our web design course platform or communicate with us (collectively referred to as the "Services"). 
        ...
        <Paragraph>
          At DesignEcourses, we prioritize your privacy and are committed to safeguarding your 
          personal information. We will never sell or share your personal details or credit card information 
          with third parties without your explicit consent.
        </Paragraph>
        <Paragraph>
          Any personal information we collect is used exclusively for providing our web design course services and 
      ...
      <Section>
        ...
        <Paragraph>
          We collect personal information from various sources to provide our web design course Services. 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          browsing activity on the Site. This data helps us understand how users interact with our web design courses 
          to           content, improving website functionality, or sending you relevant web design course recommendations.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          Advertisers or marketing partners who help us reach you with relevant web design course promotions.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          <strong>Marketing and Advertising:</strong> Send you promotional communications about new web design courses 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          With marketing partners who may use your data for targeted web design course ads or promotions.<br/>
      ...
      <Section>
        ...
        <Paragraph>
          Our Site may contain links to third-party websites or design tools. These sites have their own privacy 
      ...
      <Section>
        ...
        <Paragraph>
          Our web design course Services are not intended for children, and we do not knowingly collect information 
