...
const RefundPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          At DesignEcourses, we stand behind the quality of our web design courses and want you to be satisfied with your learning experience. 
          This refund policy outlines the terms and conditions for refunds on our digital web design course purchases.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          We offer a 7-day satisfaction guarantee on all web design course purchases. You may request a refund within 7 days 
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your web design course purchase:
        </Paragraph>
        <Paragraph>
          1. Contact our support team at support@design-ecourses.com<br/>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          You will see "DESIGN ECOURSES" or "DESIGN-ECOURSES.COM" as the refund descriptor on your statement.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit for a different web design course that better suits your needs<br/>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          by emailing support@design-ecourses.com with "Refund Appeal" in the subject line. All appeals 
